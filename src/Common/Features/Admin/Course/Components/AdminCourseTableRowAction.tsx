...
export interface AdminCourseTableRowActionProps {
  id: number;
  onClickEdit: TableOnclickFunctionType<number>;
  onClickDelete: TableOnclickFunctionType<number>;
}

const AdminCourseTableRowAction = ({ id, onClickEdit, onClickDelete }: AdminCourseTableRowActionProps) => {
  return (
...
export default memo(AdminCourseTableRowAction);
